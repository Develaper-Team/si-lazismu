                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3 pt-4 pl-5">
                                        <img class="image border border-light shadow p-2" src="<?= base_url('') ?>assets/dist/img/user-image.png" alt="Foto User" style="height: 13vw; width: 12vw;">
                                    </div>
                                    ...
                                    <div class="col-md-8 border shadow mt-4 ml-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 mt-2 ml-0">
                                                <div>Jl. Sawit No. 34, Umbulharjo, Yogyakarta, 4456 Daerah
                                                Istimewa Yogyakarta</div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 mt-2 ml-2">
                                                <div>Domisili Saat Ini</div>
                                            </div>
                                            <div class="col-md-1 pl-0 pr-0 ml-0 ml-0 mt-2 ml-2">
                                                <div>:</div>
                                            </div>
                                            <div class="col-md-7 mt-2 ml-0">
                                                <div>Jl. Duren No. 34, Sleman, Yogyakarta, 4765 Daerah
                                                Istimewa Yogyakarta</div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-flex justify-content-end">
                                              <a class="btn btn-primary" href="<?= base_url('') ?>/home/Update_Profil">Update Profil</a>
                                            </div>
